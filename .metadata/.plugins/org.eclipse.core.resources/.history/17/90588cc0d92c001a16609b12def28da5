...
public class Carte {
	/**
	 * attribut privé de type Couleur représentant la couleur de la carte
	 * {@link Couleur}
	 */
	private Couleur couleur;
	/**
	 * attribut privé de type Valeur représentant la valeur de la carte
	 * {@link Valeur}
	 */
	 ...
	 * 
	 * @param valeur  de type Valeur 
	 * @param couleur de type Couleur
	 */
	 ...
	 */
	public boolean cartePlusHaute(Carte c) {
