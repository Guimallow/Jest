...
public class Joueur {
	...
	public void piocherOffre(Joueur a, boolean carteVisible) {//enlève la carte choisie de la main et la met dans le jest
	...
	public void consulterOffre(Joueur a) {//affiche l'offre d'un joueur, les cartes non visibles sont affichés face cachée
