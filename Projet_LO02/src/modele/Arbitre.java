...
/**
 * Classe représentant l'arbitre de la partie qui va compter les points,
 * attribuer les trophées et établir le classement
 */
public class Arbitre implements Visiteur {
	...
	/**
	 * méthode permettant de visiter un jest
	 * 
	 * @param j le jest à visiter
	 */
	...
	/**
	 * méthode permettant de visiter un trophée
	 * 
	 * @param t le trophée à visiter
	 */
	...
	/**
	 * méthode permettant de compter les points d'un jest en fonction de la variante
	 * en jeu
	 * 
	 * @param jest     le jest dont il faut compter les points
	 * @param variante la variante utilisée lors de la partie
	...
	/**
	 * méthode qui vérifie si le joker est présent dans le jest
	 * 
	 * @param jest le jest visité
	 * @return le booléen qui définit si le joker est présent
	 */
	...
	/**
	 * méthode qui compte le nombre de coeurs dans le jest
	 * 
	 * @param jest le jest visité
	 * @return le nombre de coeurs présents dans le jest
	 */
	...
	/**
	 * méthode qui vérifie si la carte est la seule de cette couleur dans le jest
	 * 
	 * @param jest  le jest visité
	 * @param carte la carte dont on vérifie la couleur
	 * @return un booléen qui définit si la carte est la seule de cette couleur dans
	 *         le jest
	 */
	...
	/**
	 * méthode qui vérifie si il y a deux cartes de la même valeur avec comme
	 * couleur trêfle et pic
	 * 
	 * @param jest  le jest visité
	 * @param carte la carte comparé
	 * @return le booléen qui définit si il y a une paire de trêfle et pic
	 */
	public boolean blackPair(Jest jest, Carte carte) {
		...
		for (int i = 0; i < jest.getCartes().size(); i++) {
			...
			if (((couleur2 == Couleur.PIC) || (couleur2 == Couleur.TRÊFLE)) && (couleur1 != couleur2)
					&& (valeur1 == valeur2)) {
				paire = true;
			}
		}
	...
	/**
	 * méthode qui vérifie combien de cartes dans le jest ont la même valeur que
	 * celle choisie
	 * 
	 * @param jest   le jest visité
	...
	/**
	 * méthode qui attribue le ou les trophées aux joueurs qui remplissent les
	 * conditions d'obtention
	 * 
	 * @param joueurs  la liste des joueurs de la partie
	 * @param t1       le premier trophée
	 * @param t2       le deuxième trophée
	...
	public void attribuerTrophee(ArrayList<Joueur> joueurs, Trophee t1, Trophee t2, Variante variante) {
		...
		case Random:
			...
			break;
		default:
			System.out.println("Erreur trophée 2");
			break;
		}
	...
	/**
	 * méthode qui établit le classement en fonction du score des joueurs
	 * @param partie la partie en cours
	 * @return la liste des joueurs établit par le classement
	 */
	...
	/**
	 * méthode qui vérifie qu'une case d'un tableau est utilisée
	 * @param index la case à vérifier
	 * @param tableau le tableau testé
	 * @return le booléen qui définit si la case est utilisée
	 */
	...
	/**
	 * méthode qui échange les jests des joueurs de la partie (une des variantes)
	 * @param partie la partie en cours
	 */
	...
	/**
	 * méthode qui vérifie que le jest contient toutes les cartes d'une même valeur (une des variantes)
	 * @param jest le jest visité
	 * @param valeur la valeur testée
	 * @return le booléen qui définit si le jest contient toutes les cartes avec cette valeur
	 */
